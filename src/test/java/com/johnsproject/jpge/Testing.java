...
//		}
	...
	public Testing() {
		...
		sceneObject = new SceneObject("test", new int[] {0, 0, 500}, new int[] {90, 0, 0}, new int[] {1, 1, 1}, mesh);
		//sceneObject2 = new SceneObject("test2", new Vector3(0, 0, 150), new Vector3(0, 0, 0), new Vector3(1, 1, 1), mesh2);
		camera = new Camera("testCam", new int[] {0, 0, 0}, new int[] {0, 0, 0}, new int[] {0, 0}, new int[] {w, h});
		//camera2 = new Camera("testCam2", new int[] {0, 0, 0}, new int[] {0, 0, 0}, new int[] {700, 200}, new int[] {w/2, h/2});
		light = new Light("testLight", new int[] {0, 0, 0}, new int[] {0, 0, 0});
